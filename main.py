...
app = FastAPI()
positive = ['хорош', 'люблю', 'отличн', 'нравит', 'доволен', 'понравил', 'радует', 'класс', 'супер']
negative = ['плохо', 'ненавиж', 'ужас', 'огорч', 'отстой', 'разочарован', 'не нрав', 'не понравил', 'не доволен', 'не радует']
